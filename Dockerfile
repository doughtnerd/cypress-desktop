...
#
# The original image has been altered to add nodejs and cypress support.
#
# Author:
# Chris Carlson <doughtnerd@gmail.com>
#


FROM ubuntu:18.04
LABEL maintainer Chris Carlson <doughtnerd@gmail.com>
...
# ENV CYPRESS_RUN_BINARY=/home/ubuntu/Cypress/Cypress

RUN curl -sL https://deb.nodesource.com/setup_16.x | sudo -E bash -
RUN sudo apt-get install -y nodejs

COPY image/home/cypress.zip /home/ubuntu/cypress.zip
RUN CYPRESS_CACHE_FOLDER=/home/ubuntu/Cypress CYPRESS_INSTALL_BINARY=/home/ubuntu/cypress.zip npm install -g cypress
RUN sudo chmod 777 -R /home/ubuntu/Cypress
# RUN CYPRESS_INSTALL_BINARY=0 npm install -g cypress cypress-file-upload

ADD image/etc /etc
ADD image/usr /usr
ADD image/sbin /sbin
# COPY image/home/Cypress $DOCKER_HOME/Cypress/
